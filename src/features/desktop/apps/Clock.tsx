...
export const Clock: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-white font-sans ">
      <div className="p-20 flex flex-col items-center max-w-md w-full mx-4">
        
        <div className="text-sm font-medium text-taupe-400  mb-6 uppercase">
          {formatDate()}
        </div>
        ...
        <div className="flex items-baseline font-bold text-taupe-100/90">
          ...
          {!is24H && (
            <span className="ml-3 text-lg font-bold text-amber-400 uppercase self-end pb-1.5">
              {ampm}
            </span>
          )}
        </div>
        ...
        <button
          ...
          className="mt-8 px-5 py-2.5 text-xs font-semibold rounded-full border border-taupe-700 hover:border-amber-600 bg-taupe-800/40 hover:bg-amber-500/10 text-taupe-300 hover:text-amber-300 transition-all cursor-pointer"
        >
