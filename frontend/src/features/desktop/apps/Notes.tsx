            ...
            <aside className="flex w-80 flex-col w-[40%] max-w-[220px]">
                <div className="p-4 flex flex-col gap-3">
                    ...
                    <input
                        ...
                        className="text-taupe-100 w-full rounded-lg bg-taupe-50/30 px-3 py-1.5 text-[14px] outline-none border border-white/20 focus:border-indigo-500 focus:border-white "
                    />
                </div>

                <div className="flex-1 overflow-y-auto p-3 space-y-2 max-w-[220px] ">
                    {filtered.length === 0 ? (
                        <div className="text-center text-[14px] text-taupe-400 mt-8">No notes found :/</div>
                    ) : (
                        filtered.map((note) => {
                    ...
                    <div className="flex flex-1 flex-col p-6 max-w-4xl w-full mx-auto">
                        ...
                        <div className={`flex flex-1 flex-col rounded-2xl border p-6 ${color} text-taupe-800/90 dark:text-taupe-300`}>
                            ...
                            <textarea
                                ...
                                className="mt-4 w-full flex-1 text-[14px] leading-relaxed outline-none placeholder:opacity-50"
                            />
                        </div>
                    </div>
                ) : (
